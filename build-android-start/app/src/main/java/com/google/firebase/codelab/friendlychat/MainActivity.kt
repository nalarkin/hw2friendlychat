...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // . This code adds all existing messages from Realtime Database and then listens for new
        // child entries under the messages path in your Firebase Realtime Database. It adds a
        // new element to the UI for each message:
